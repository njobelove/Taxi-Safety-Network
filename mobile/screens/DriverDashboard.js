  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.topBar}>
        <View style={s.topLeft}>
          ...
          <View>
            ...
            <Text style={s.appFr}>RÉSEAU DE SÉCURITÉ DES{'\n'}TAXIS</Text>
          </View>
        </View>
        <View style={s.topRight}>
          <View style={s.mtnBadge}>
            <Text style={s.mtnTxt}>MTN{'\n'}CM</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Driver identity + duty card */}
        <View style={s.idRow}>
          <View style={s.idCard}>
            <Text style={s.idLabel}>DRIVER IDENTITY /{'\n'}IDENTITÉ DU CHAUFFEUR</Text>
            <Text style={s.idNum}>TX-YDE-001</Text>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 6 }}>
              <Text style={{ fontSize: 13, marginRight: 4 }}>📍</Text>
              <Text style={s.distTxt}>Yaoundé District</Text>
            </View>
          </View>
        ...
        <View style={s.panicOuter}>
          ...
          <Text style={s.panicHint}>HOLD FOR 3 SECONDS TO ALERT CENTRAL{'\n'}COMMAND</Text>
          <Text style={s.panicHintFr}>MAINTENEZ 3S POUR ALERTER LE CENTRE</Text>
        </View>
        ...
        <View style={s.tilesCard}>
          ...
          <View style={s.tilesRow}>
            <TouchableOpacity style={s.tile}>
              <View style={s.orgBadge}><Text style={s.orgTxt}>ORG</Text></View>
              <Text style={s.tileTxt}>SIGNAL{'\n'}QUALITY</Text>
              <Text style={s.tileFr}>QUALITÉ</Text>
            </TouchableOpacity>
            <View style={s.tileDivV} />
            <TouchableOpacity style={s.tile} onPress={() => nav('emergency')}>
              <Text style={s.tileIco}>🚦</Text>
              <Text style={s.tileTxt}>TRAFFIC{'\n'}ALERT</Text>
              <Text style={[s.tileFr, { color: RED }]}>NSAM: HEAVY /</Text>
            </TouchableOpacity>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  dutyCard:  { width: 100, backgroundColor: '#e8f0fe', borderRadius: 16, padding: 14, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
