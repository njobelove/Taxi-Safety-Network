    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={s.card}>
          ...
          <View style={s.div}/>
          <Row icon="sms"           title="Offline SMS Fallback"   subtitle="Send SMS to police if no internet"            value={offlineSMS}    onChange={setOfflineSMS}/>
        </View>
        ...
        <View style={s.card}>
          ...
          <View style={s.div}/>
          <Row icon="description"   title="Terms of Service"       subtitle="Read our terms and privacy policy"            type="button" onPress={()=>Alert.alert('Terms of Service','TSN is a safety platform for taxi drivers in Cameroon. All data is encrypted and used only for emergency response.')}/>
          <View style={s.div}/>
        ...
        <View style={s.card}>
          <Row icon="delete" title="Clear Local Data" subtitle="Remove saved photo and voice note" type="button" danger
            onPress={()=>Alert.alert('Clear All Data','This will clear your profile photo and voice note.\n\nYour account and alerts will NOT be deleted.',[{text:'Cancel',style:'cancel'},{text:'Clear Data',style:'destructive',onPress:()=>{try{const uid=user?.badgeId||user?.stationId;localStorage.removeItem('tsn_photo_'+uid);localStorage.removeItem('tsn_voice_'+uid);}catch(e){}Alert.alert('Done','Local data cleared.');}}])}
          />
          <View style={s.div}/>
          <Row icon="person-remove" title="Delete Account" subtitle="Contact support to delete your account" type="button" danger onPress={()=>Linking.openURL('mailto:support@tsn-cameroon.com')}/>
        </View>
